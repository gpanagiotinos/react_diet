export const config = {
  ...
  usdaGroup100Foods: (foodGroup) => (`https://api.nal.usda.gov/ndb/search/?format=${'json'}&q=&sort=${'n'}&max=${200}&offset=${0}${'&fg='+foodGroup}&ds=Standard Reference&api_key=${process.env.USDA_API_KEY}`),
